...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("9b9XKVazmyMcWHxO0YaDEMBq12bELjukpu0EtuxuxYA98Ayfr2");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("JQJBAwSOi5tq2PuATX1xis2q9JChGEhHHslmIsnN4cK8vRa7bB");
        useraccessdomain.setDomainHelp("aLvF1JKlKgJo0PCKe4vgYM2MoizoeGdd29QacEc2Vr4OKvXU9v");
        useraccessdomain.setDomainName("PjFN2iL7KB1M8myNzMWBeMsnnhCQCMOn0bWzz4dp90Mti3P9Go");
        ...
        useraccesslevel.setLevelDescription("FJlIw8qIaIvPExTeIe6ICfGiBsRMHNgVEigqrjSdClz31Bq7dQ");
        useraccesslevel.setLevelName("5QQfHyPIaRTHAa7edRqGcvuv7Rq650smLOq2JIsPAphkr0PZXc");
        useraccesslevel.setLevelIcon("FHaIEi46QoujJPiFxb5hBvhacxpPrcfB0l2rdciSb6CNZJyh0I");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("jiZ23CkvkMkZjQDvjuyuU5QQaKCWz2783i6nLBUtD8V4p9Pne8");
        ...
        User user = new User();
        user.setSessionTimeout(2104);
        user.setUserAccessCode(29024);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setChangePasswordNextLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("aUrwJA5YodavBqMrrl3fUeGwrILcVLJzLs6wYKU3ZNMnmG3ecY");
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setIsDeleted(1);
        user.setAllowMultipleLogin(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1467187949400l));
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1467187949400l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("moGSKDmz9SVtGvQhGiRWAUsjVNN5VydV3kyRNNZH1bgYjjjnC3");
        Question question = new Question();
        question.setQuestionIcon("u9fcIf3SnCGfAhjgr9Q0WLyqGw7d3JVHz6iJpIp2yM5zNf9RBQ");
        question.setQuestionDetails("1kO7pklMnk");
        question.setLevelid(6);
        question.setQuestion("rRqXB4SdlZTJMK1RrEIEHah7faPwmHSYuU8lsrX5JOXHIjyCUO");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("NvMogpc00YFKj4E5tUEmNG5k4JAYcB3djGqMkQ7obEJyrU34BK");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("YXVjyKE2ZR5j3EJ4NJKwOEwPDTWaSNgtzq4YVZTmDXgjGCkRVN");
        userdata.setLast5Passwords("bKmVVCa5RqhNMKeqUcHj9gF8cbeYugbaFFz0vmFSa3v0opvHWC");
        userdata.setOneTimePasswordExpiry(8);
        userdata.setPassword("Jz0o7vd0sqfJyCvMt2htyQdM0DWRS7MLj7bKesGB0xy2c9SeP8");
        userdata.setLast5Passwords("YVjZfrCF1x8yuY9QFmVVlIyXKPVVwAeJUxp7kAQWQesKqqhR1Q");
        userdata.setOneTimePasswordExpiry(1);
        userdata.setUser(user);
        userdata.setOneTimePassword("yMJqjc0CAlOH3xobSaETkzELEan1zFcr");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1467187950190l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 73537));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "TGOmsd8YDZIgiAEl2PzZ1Fu8mybmHgb55pAFrq7N6RntjOIRWyNaquDoVaNs8wRIC"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 7107));
