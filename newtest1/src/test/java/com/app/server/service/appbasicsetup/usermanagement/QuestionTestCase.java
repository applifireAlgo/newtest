...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("SE8IuHcYWJ1pNZ2p5nFiLiqNqE2pw4K5dphNatQmd724rt741W");
        question.setQuestionDetails("X8CrwAEZdc");
        question.setLevelid(2);
        question.setQuestion("CjsAiuBs1cMASvtmXkVhdXAOrU80C5iWwVHzmvKmWITMp6Em7x");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("nIOIgrvKfgcp5F5mqW1efrsqEPXOLsqY9fS9s4QC8JyfUpcNBD");
            question.setQuestionDetails("7qu6MP2hNv");
            question.setLevelid(1);
            question.setQuestion("QHXfVEhOxyJegjlwTAqiPVWDBSrGhl5iT2mwoKykhiJOeH9oeh");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ALCQWz8nYZoUvsTPQo0NT7mbu2HuB9vlG9fYIKuY6dNSBAJLU31ajezKmgwTaJmMN"));
