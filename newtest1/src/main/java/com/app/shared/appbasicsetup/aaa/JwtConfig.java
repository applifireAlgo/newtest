...
@NamedQueries({ @javax.persistence.NamedQuery(name = "JwtConfig.findById", query = "select e from JwtConfig e where e.systemInfo.activeStatus=1 and e.configId =:configId") })
