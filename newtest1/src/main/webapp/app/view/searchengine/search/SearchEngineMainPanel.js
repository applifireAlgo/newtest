Ext.define('Newtest1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Newtest1.view.searchengine.search.NorthPanel', 'Newtest1.view.searchengine.search.SearchResult','Newtest1.view.searchengine.search.SearchEngineMainPanelController'],
