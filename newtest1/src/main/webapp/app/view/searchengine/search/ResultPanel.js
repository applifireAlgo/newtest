Ext
		.define(
				'Newtest1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newtest1.view.searchengine.search.SearchEngineMainPanelController','Newtest1.view.searchengine.search.PanelHeaderField' ,'Newtest1.view.searchengine.search.ReportGridView','Newtest1.view.searchengine.search.ReportChartView','Newtest1.view.searchengine.search.documentView','Newtest1.view.searchengine.search.DouMeanView','Newtest1.view.googlemaps.map.MapPanel'],
