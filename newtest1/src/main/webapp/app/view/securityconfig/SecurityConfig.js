 ...
 * 
 */
Ext.define('Newtest1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newtest1.view.securityconfig.SecurityConfigController',
			'Newtest1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
