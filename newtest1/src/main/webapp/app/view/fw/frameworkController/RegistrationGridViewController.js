Ext.define('Newtest1.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Newtest1.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Newtest1.view.console.ConsoleWindow');
