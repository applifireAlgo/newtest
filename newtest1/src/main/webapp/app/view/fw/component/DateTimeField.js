 ...
 */
Ext.define('Newtest1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Newtest1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Newtest1.view.fw.component.DateTimePicker(o);
    },
