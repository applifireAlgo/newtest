 ...
 * 
 */
Ext.define('Newtest1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newtest1.view.logalarm.mainscreen.AddLogAlarmController',
			'Newtest1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newtest1.view.logalarm.mainscreen.AppAlarmPanel',
