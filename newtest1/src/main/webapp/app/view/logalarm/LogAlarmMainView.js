 ...
 * 
 */
Ext.define('Newtest1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Newtest1.view.logalarm.LogAlarmMainViewController',
			'Newtest1.view.logalarm.tree.LogAlarmTreePanel',
			'Newtest1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
