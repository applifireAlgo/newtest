 ...
 * 
 */
Ext.define('Newtest1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newtest1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
