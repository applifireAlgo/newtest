Ext.define('Newtest1.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Newtest1.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Newtest1.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Newtest1.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Newtest1.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Newtest1.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Newtest1.view.clouddrive.CloudDrive");
    },
