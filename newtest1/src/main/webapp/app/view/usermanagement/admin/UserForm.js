Ext.define('Newtest1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Newtest1.view.usermanagement.admin.AddUserDetailsViewModel', 'Newtest1.model.AddUserDataModel' ],
