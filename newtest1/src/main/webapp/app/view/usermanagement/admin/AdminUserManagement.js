Ext.define('Newtest1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newtest1.view.usermanagement.admin.UserPasswordReset',
	            'Newtest1.view.usermanagement.admin.AddUserDetails',
	            'Newtest1.view.usermanagement.admin.ViewUser'],
